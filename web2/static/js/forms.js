let emojis_select_settings = {
    options: [],
    placeholder_html: "Search for an emoji."
}
...
function static_post_tweet_form() {
    ...
    input_elem.classList.add("disabled")
    ...
    handle_form_submitting(btn.id, (res) => {
        ...
        input_elem.classList.remove("disabled")
    })
}
...
function validate_and_sign_up(username, password, conf_password, user_emoji) {
    ...
    let password_elem = document.getElementById('sign_up_password')
    password_elem.classList.remove('is-invalid')

    let conf_password_elem = document.getElementById('sign_up_conf_password')
    conf_password_elem.classList.remove('is-invalid')
    ...
    if (password != conf_password) {
        conf_password_elem.classList.add('is-invalid')
        invalid = true
    }
    ...
    sign_up(username, password, user_emoji)
}
...
function sign_up_modal() {
    ...
    modal_body.innerHTML = `
        ...
        <div class="form-floating mb-2">
            ...
            class="form-control" id="sign_up_password" name="sign_up_password" value="">
            <label class="ms-1" for="sign_up_password">Password</label>
        ...
        <div class="form-floating mb-2">
            <input type="password" autocomplete="current-password"
            class="form-control" id="sign_up_conf_password" name="sign_up_conf_password" value="">
            <label class="ms-1" for="sign_up_conf_password">Confirm Password</label>
            <div class="invalid-feedback">
    ...
    sign_up_btn.onclick = function() {
        ...
        let conf_password = document.getElementById('sign_up_conf_password').value
        let user_emoji = document.getElementById("sign_up_profile_emoji").value

        validate_and_sign_up(username, password, conf_password, user_emoji)
    }
}
...
function log_in_modal() {
    ...
    modal_body.innerHTML = `
        ...
        <div class="form-floating">
            <input type="password" autocomplete="current-password"
            class="form-control" id="log_in_password" name="log_in_password" value="">
            <label class="ms-1" for="log_in_password">Password</label>
        </div>
    `
